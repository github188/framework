...
public class StringUtil {
	...
	public static String lowerDateTrans(String transStr) {
		...
		try {
			...
			int iday = Integer.parseInt(transStr.substring(8,
					transStr.length() - 1));
	...
	public static String getQueryCode(String character) {
		...
		String Strhz[] = {
				" 锕 捱 嗳 嗌 嫒 瑷 暧 砹 锿 霭 谙 埯 揞 犴 庵 桉 铵 鹌 黯 "
	...
	public static String transferSql(String str, char escapeCh) {
		if (str != null && !"".equals(str)) {
			...
			throw new java.lang.IllegalArgumentException("传入的字符串必须有值！");
	}
    ...
    public static void main(String[] args) {
    	/* double lat = 30.457014;  
         double lng = 114.424444;  
   
         double lat1 = 30.455305;  
         double lng1 = 114.424858;  
         double d2 = GetDistance(lat, lng, lat1, lng1);  
         System.out.println(d2);  */
    	System.out.println(getPercent(0, 1));
	}
