...
<!-- 	    			<td width="200px"><input class="easyui-validatebox" type="text" name="username"   data-options="required:true,validType:'length[1,25]'" validType="remote['${pageContext.request.contextPath}/userController/validateLoginCode.action','username']" invalidMessage="该登录账号重复,请重新输入"></input></td> -->
	    			<td width="200px"><input class="easyui-validatebox" type="text" name="username"   data-options="required:true,validType:'length[1,25]'"></input></td>
...
<!-- 	    			<td width="200px"><input id="admin_zyglAdd_pid" name="orgId" class="easyui-combotree" data-options="url:'${ctx}/orgController/treegrid.action',parentField : 'pid',lines : true,required:true" style="width: 150px;" /><img src="${ctx}/style/images/extjs_icons/cut_red.png" onclick="$('#admin_zyglAdd_pid').combotree('clear');" /> -->
<!-- 				</td> -->
