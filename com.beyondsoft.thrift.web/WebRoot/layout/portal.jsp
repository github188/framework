...
<script type="text/javascript" charset="utf-8">
	$(function() {
		panels = [ {
			...
			height : 200,
			collapsible : true,
			href:'${ctx}/layout/portal/about.jsp'
		}, {
			id : 'p2',
			title : 'link',
			height : 200,
			collapsible : true,
			href:'${ctx}/layout/portal/link.jsp'
		}, {
			id : 'p3',
			title : '修复数据库',
			height : 200,
			collapsible : true,
			href:'${ctx}/layout/portal/repair.jsp'
		}, {
			id : 'p4',
			title : '说明',
			height : 200,
			...
			height : 200,
			collapsible : true,
			href:'${ctx}/layout/portal/about2.jsp'
		} , {
			id : 'p6',
			title : 'QQ群',
			height : 200,
			collapsible : true,
			href:'${ctx}/layout/portal/qun.jsp'
		} ];
