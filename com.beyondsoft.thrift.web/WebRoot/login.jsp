...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="userController/login.action" check="userController/checkUserLogin.action" method="post">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright"> <span class="tip"> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)</span></div>
    </div>
    <!-- Link JScript-->
